...
export const TOOL_CONTRACTS: Record<string, ToolContract> = {
  ...
  post_record: {
    name: "post_record",
    intent: "post-record",
    scripts: ["records.records.spend"],
    nested: [],
    requires: ["ready", "wallet", "pnft"],
  },
  reveal_record: {
    name: "reveal_record",
    intent: "reveal-record",
    scripts: ["records.records.spend"],
    nested: [],
    requires: ["ready", "wallet", "pnft"],
  },
  ...
  presale_grant: {
    name: "presale_grant",
    intent: "presale-grant",
    scripts: ["grants.grants.spend"],
    nested: [],
    requires: ["ready", "wallet", "pnft"],
  },
  presale_offtake: {
    name: "presale_offtake",
    intent: "presale-offtake",
    scripts: ["grants.grants.spend"],
    nested: [],
    requires: ["ready", "wallet", "pnft"],
  },
