...
export interface TxSummary {
  action: string; description: string; pnftId?: string; offeringId?: string; agreementId?: string;
  collectiveId?: string; recordId?: string; treasuryAddress?: string; from?: string; to?: string;
  amount?: bigint; newMember?: string; costs: { ada?: string; tokens?: bigint }; receives?: { pnft?: string; tokens?: bigint };
}
