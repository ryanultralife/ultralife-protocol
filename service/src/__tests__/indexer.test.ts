...
// Test configuration
const testConfig: UltraLifeConfig = {
  network: 'preprod',
...
describe('UltraLifeIndexer', () => {
  ...
  describe('Treasury State', () => {
    it('should return default treasury state when no data on chain', async () => {
      ...
      expect(state.totalSupply).toBe(400_000_000_000_000_000n);
      expect(state.distributed).toBe(0n);
      expect(state.reserved).toBe(400_000_000_000_000_000n);
    ...
    it('should have valid total supply of 400B tokens', async () => {
      ...
      const expectedSupply = 400_000_000_000n * 1_000_000n;
